 ...
 */
{
  "carousel": {
    ...
    "extraFields": [
      ...
      // Средний урон.
      { "x": 2,  "y": 78, "format": ${"carousel/carouselDmg.xc":"format1"}},
      { "x": 22, "y": 79, "format": ${"carousel/carouselDmg.xc":"format2"}, "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 0.8, "blur": 2, "strength": 3 } },
      // Эффективность на танке.
      { "x": 2,  "y": 60, "format": ${"carousel/carouselxTE.xc":"format1"}},
      { "x": 22, "y": 62, "format": ${"carousel/carouselxTE.xc":"format2"}, "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 0.8, "blur": 2, "strength": 3 } },
      // Уровень боев.
	  ...
	  // Отметки на стволе.
      { "x": 105,  "y": 12, "format": ${"carousel/carouselDmgR.xc":"format1"}},
      { "x": 124,  "y": 14, "format": ${"carousel/carouselDmgR.xc":"format2"}, "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 0.8, "blur": 2, "strength": 3 } },
      // Sign of mastery.
      // Знак мастерства.
