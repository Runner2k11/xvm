 ...
 */
{
  ...
  "small": {
    ...
    "fields": {
      ...
      "info":     { "enabled": true, "dx": 0, "dy": 0, "alpha": 100, "scale": 0.8 },
    ...
    "extraFields": [
      ...
      // Sign of mastery
      // Процент побед
      {"enabled": ${"carousel/carouselWin.xc":"enabled"}, "x": 24, "y": 17, "format": "<font face='$FieldFont' size='12' color='{{v.c_winrate}}'>{{v.winrate%d~%| }}</font>", "shadow": ${ "def.textFieldShadow" }},
      // Vehicle name
      // Название танка
      {"enabled": true, "x": 159, "y": 14, "align": "right", "format": "<font face='$FieldFont' size='15' color='{{v.premium?#FFA759|#C8C8B5}}'>{{v.name}}</font>", "shadow": { "$ref": { "path": "def.textFieldShadow" }, "color": "{{v.premium?0xFC3700|0xC8C8B5}}", "alpha": "{{v.premium?85|35}}", "blur": "{{v.premium?10|8}}"}},
      // Sign of mastery.
      // Знак мастерства.
      {"enabled": true, "x": 4, "y": 14, "format": "<img src='img://gui/maps/icons/library/proficiency/class_icons_{{v.mastery}}.png' width='23' height='23'>" }
    ]
  }
}